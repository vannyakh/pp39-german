<template>
    <view class="asset-overview-container">
        ...
        <scroll-view
            ...
            :style="{ borderBottomColor: theme.neutral__200 }"
        >
            <view class="nav-tabs">
                <view
                ...
                >
                    ...
                    <view
                        ...
                        :style="{ background: theme.primary__light }"
                    ></view>
                </view>
            </view>
        </scroll-view>
        ...
        <view class="tab-content-container">
            ...
            <view v-if="currentTabIndex === 0" class="tab-content">
                            ...
                            >{{
                                showAssetValue
                                    ? formatAmount(
                                          "overview",
                                          userAssets.overview &&
                                              userAssets.overview.totalAsset,
                                      )
                                    : "****"
                            }}</text
                        >
                ...
                <view class="action-buttons">
                    ...
                    >
                        <image
                            class="action-icon"
                            src="/static/imgs/my/deposit-1.png"
                            mode="aspectFit"
                        ></image>
                        <text
                            class="action-text"
                    ...
                    >
                        <image
                            class="action-icon"
                            src="/static/imgs/my/withdrawal.png"
                            mode="aspectFit"
                        ></image>
                        <text
                            class="action-text"
                    ...
                    >
                        <image
                            class="action-icon"
                            src="/static/imgs/my/exchange.png"
                            mode="aspectFit"
                        ></image>
                        <text
                            class="action-text"
                            :style="{ color: theme.textPrimary }"
                            >{{ $t("transfer.title") }}</text
                        >
                    </view>
                </view>
                    ...
                    >
                        ...
                        <view class="asset-breakdown">
                            <view
                                class="asset-item"
                                :style="{
                                    borderBottomColor: theme.neutral__200,
                                }"
                            >
                                <text
                                    class="asset-name"
                                ...
                                <view class="asset-value-wrapper">
                                    ...
                                    <text
                                        v-if="
                                            showAssetValue &&
                                            userAssets.overview &&
                                            userAssets.overview.cad_usd
                                        "
                                        class="asset-value-subtitle"
            ...
            <view v-if="currentTabIndex === 1" class="tab-content">
                ...
                <view class="action-buttons">
                    ...
                    <view
                        ...
                        class="action-button exchange"
                        :style="getButtonStyle()"
                    >
                        <image
                            class="action-icon"
                            src="/static/imgs/my/transfer-1.png"
                            mode="aspectFit"
                        ></image>
                        <text
                            class="action-text"
            ...
            <view v-if="currentTabIndex === 2" class="tab-content">
                ...
                <view
                    class="total-asset-us-section"
                    :style="{ background: theme.backgroundCard }"
                >
                    <view class="total-asset-us-header">
                        <text
                            class="total-asset-us-label"
                            :style="{ color: theme.textSecondary }"
                            >{{ $t("total_asset_ca") }}</text
                        >
                        <view
                            @click="handleTransfer"
                        ...
                        >
                            <image
                                class="transfer-icon"
                                src="/static/imgs/my/exchange-1.png"
                                mode="aspectFit"
                            ></image>
                            <text
                                class="transfer-text"
            ...
            <view v-if="currentTabIndex === 3" class="tab-content">
                ...
                <view
                    class="total-asset-ca-section"
                    :style="{ background: theme.backgroundCard }"
                >
                    <view class="total-asset-ca-header">
                        <text
                            class="total-asset-ca-label"
                            :style="{ color: theme.textSecondary }"
                            >{{ $t("total_asset_us") }}</text
                        >
                        <view
                            @click="handleTransfer"
                            class="transfer-button"
            ...
            <view v-if="currentTabIndex === 4" class="tab-content">
                ...
                <view
                    class="total-asset-usdt-section"
                    :style="{ background: theme.backgroundCard }"
                >
                    <view class="total-asset-usdt-header">
                        <text
                            class="total-asset-usdt-label"
                            :style="{ color: theme.textSecondary }"
                            >{{ $t("total_asset") }}</text
                        >
                        <view
