<template>
	<view class="forget-page min-height-screen-teb">
		...
		<view class="forget-card" :style="{ background: theme.backgroundPrimary }">
			<view class="card-header">
				<text class="card-title" :style="{ color: theme.textPrimary }">{{$t('login5')}}</text>
			</view>
			...
			<view class="tab-switcher" :style="{ background: theme.backgroundTertiary }">
				...
				>
					<u-icon name="phone" size="20" :color="resetType === 'phone' ? theme.primary__light : theme.textTertiary"></u-icon>
					<text class="tab-text" :style="{ color: resetType === 'phone' ? theme.primary__light : theme.textTertiary }">
						{{ $t('register.phone') }}
					</text>
				</view>
				<view
				...
				>
					<u-icon name="email" size="20" :color="resetType === 'email' ? theme.primary__light : theme.textTertiary"></u-icon>
					<text class="tab-text" :style="{ color: resetType === 'email' ? theme.primary__light : theme.textTertiary }">
						{{ $t('register.email') }}
					</text>
				</view>
			</view>
			...
			<view v-if="resetType === 'phone'" class="input-group">
				<view class="input-container" :style="{ background: theme.backgroundTertiary }">
					<view class="input-icon">
						<u-icon name="phone" size="20" :color="theme.neutral__400"></u-icon>
					</view>
					<view class="country-selector" @click="countryType=true" :style="{ background: theme.primary__50 }">
						...
						<u-icon name="arrow-down" size="12" :color="theme.neutral__400"></u-icon>
					</view>
					<input
						class="input-field"
						type="number"
			...
			<view class="input-group">
				<view class="input-container" :style="{ background: theme.backgroundTertiary }">
					...
					<input
						...
						:style="{ color: theme.textPrimary }"
					/>
					<view @click="cutTime()" class="code-button" :class="{'disabled': !timeFlag}" :style="getCodeButtonStyle()">
						<text class="code-text" :style="{ color: theme.white }">{{codeText}}</text>
					</view>
				</view>
			</view>
			...
			<view class="input-group">
				<view class="input-container" :style="{ background: theme.backgroundTertiary }">
					<view class="input-icon">
						<u-icon name="lock" size="20" :color="theme.neutral__400"></u-icon>
					</view>
					<input
						class="input-field"
						type="text"
			...
			<view class="reset-button-container">
				...
				>
					<text class="button-text" :style="{ color: theme.white }">{{$t('login27')}}</text>
				</button>
			</view>
		</view>
